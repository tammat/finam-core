...
def test_only_safe_non_execution_requests_are_registered() -> None:
    ...
    assert {item.request_kind for item in definitions} == {"RESEARCH_REFRESH", "EDGE_SEARCH_RUN", "PAPER_OBSERVATION", "OPERATOR_DECISION_ACKNOWLEDGE", "OPERATOR_DECISION_MEASURE"}
