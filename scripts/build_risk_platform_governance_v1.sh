...
echo "=== BUILD_RISK_PLATFORM_GOVERNANCE_V1 ==="

mkdir -p src/scripts scripts

cat > src/scripts/build_risk_platform_governance_v1.py <<'PY'
...
cat > scripts/test_risk_platform_governance_v1.sh <<'SH_TEST'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x scripts/test_risk_platform_governance_v1.sh
scripts/test_risk_platform_governance_v1.sh

echo "VERDICT=BUILD_RISK_PLATFORM_GOVERNANCE_V1_OK"
