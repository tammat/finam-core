...
assert {item.container_code.value for item in ready_container_definitions_v2()} == {"HOME", "EDGE", "PORTFOLIO", "SETTINGS"}
print("settings_source=OperatorSettingsV1")
print("real_targets_ready=4")
print("targets_pending=5")
