...
python -m py_compile \
  src/scripts/run_runtime_governance_service.py \
...
python src/scripts/run_runtime_governance_service.py --help >/dev/null

echo "OK: run_runtime_governance_service compile"
