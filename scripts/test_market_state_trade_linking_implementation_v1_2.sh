...
echo "=== TEST_MARKET_STATE_TRADE_LINKING_IMPLEMENTATION_V1_2 ==="
...
print("orders_sent=0")
print("VERDICT=MARKET_STATE_TRADE_LINKING_IMPLEMENTATION_V1_2_OK")
PY

echo "TEST_MARKET_STATE_TRADE_LINKING_IMPLEMENTATION_V1_2_OK"
