...
echo "=== TEST_DASHBOARD_ALL_ROUTES_HEALTHCHECK_V5 ==="
...
if [ "$failures" -ne 0 ]; then
  echo "VERDICT=DASHBOARD_ALL_ROUTES_HEALTHCHECK_V5_FAILED"
  exit 1
fi

echo "VERDICT=DASHBOARD_ALL_ROUTES_HEALTHCHECK_V5_OK"
echo "TEST_DASHBOARD_ALL_ROUTES_HEALTHCHECK_V5_OK"
