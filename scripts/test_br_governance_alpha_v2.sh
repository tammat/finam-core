...
echo "TEST_BR_GOVERNANCE_ALPHA_V2_1_1_START"
...
grep -q "BR_GOVERNANCE_ALPHA_V2_1" /tmp/br_governance_alpha_v2.out
grep -q "BR_POLICY_CANDIDATE" /tmp/br_governance_alpha_v2.out
grep -q "BR_POLICY_SUMMARY" /tmp/br_governance_alpha_v2.out
grep -q "BR_GOVERNANCE_ALPHA_V2_1_OK" /tmp/br_governance_alpha_v2.out

echo "TEST_BR_GOVERNANCE_ALPHA_V2_1_OK"
