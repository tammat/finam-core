...
echo "=== BUILD_EDGE_SPRINT_FAST_RUN_V1 ==="

cat > scripts/test_edge_sprint_fast_run_v1.sh <<'TEST'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x scripts/test_edge_sprint_fast_run_v1.sh
scripts/test_edge_sprint_fast_run_v1.sh

echo "VERDICT=BUILD_EDGE_SPRINT_FAST_RUN_V1_OK"
