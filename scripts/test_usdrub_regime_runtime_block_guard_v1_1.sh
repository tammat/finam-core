...
echo "=== TEST USDRUB REGIME RUNTIME BLOCK GUARD V1.1 ==="
...
grep -q "USDRUB_REGIME_RUNTIME_BLOCK_GUARD_V1_1" src/finam_core/pipelines/paper_pipeline.py
grep -q "callsite=usdrubf_paper_bypass" src/finam_core/pipelines/paper_pipeline.py
...
echo TEST_USDRUB_REGIME_RUNTIME_BLOCK_GUARD_V1_1_OK
