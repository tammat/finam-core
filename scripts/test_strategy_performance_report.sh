...
| grep -E "SIGNALS_BY_STRATEGY|RISK_DECISIONS|TRADES_BY_SYMBOL_SOURCE|PNL_BY_SOURCE_SYMBOL|CLOSED_TRADES_PERFORMANCE|REJECTION_REASONS|RECENT_TRADES" >/dev/null
