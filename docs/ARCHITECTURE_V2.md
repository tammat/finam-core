# MARKETCORE — ARCHITECTURE FREEZE V2
...
MARKETCORE — исследовательская платформа для поиска, проверки, объяснения и наблюдения торговых преимуществ до допуска каких-либо решений к реальному исполнению.
...
MARKETCORE перешел от стадии построения исследовательской системы к стадии развития аналитической платформы.
