            ...
            decisions.append(
                decide_strategy_promotion_v1(
                    StrategyPromotionEngineInput(
                        ...
                        quality_partial_ratio=float(row[9] or 0.0),
                        risk_context_weak_ratio=float(row[10] or 0.0),
                        score=float(row[11] or 0.0),
                        rank_status=str(row[12] or ""),
                        fill_quality_status=str(row[13] or "UNKNOWN"),
                        reconstruction_allowed=bool(row[14]),
                        lifecycle_state=str(row[15] or "UNKNOWN"),
                    )
                )
            )
