...
def main() -> int:
    ...
    print("NG_GOVERNANCE_REPLAY_V1", flush=True)
    print(
        "NG_GOVERNANCE_REPLAY_CONFIG",
    ...
    print("NG_GOVERNANCE_REPLAY_V1_OK", flush=True)
    return 0
