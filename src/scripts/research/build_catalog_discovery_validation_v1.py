...
def main() -> int:
    ...
    ok = (
        ...
        and source_map.get("PythonDiscovery", 0) >= 1 and source_map.get("BashDiscovery", 0) >= 1 and source_map.get("SystemdDiscovery", 0) >= 1
    )

    print("=== CATALOG_DISCOVERY_VALIDATION_V1_2 ===")
    ...
    print("VERDICT=CATALOG_DISCOVERY_VALIDATION_V1_2_READY" if ok else "VERDICT=CATALOG_DISCOVERY_VALIDATION_V1_2_FAILED")
