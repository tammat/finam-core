...
DDL = """
CREATE TABLE IF NOT EXISTS lkoh_shadow_signals (
...
CREATE INDEX IF NOT EXISTS idx_lkoh_shadow_signals_symbol_ts
ON lkoh_shadow_signals(symbol, signal_ts DESC);
"""
    ...
    SELECT
        ...
        CASE
            ...
            WHEN prev_close IS NOT NULL
             ...
             AND ma12 < ma36
             AND close < prev_close
            THEN 'lkoh_m5_downtrend_momentum'
            ELSE NULL
        END AS reason,
        ma12,
        ma36,
...
INSERT = """
INSERT INTO lkoh_shadow_signals (
    symbol,
    strategy,
    timeframe,
    signal_ts,
...
def main() -> int:
    print("=== LKOH SHADOW SIGNAL RESEARCH V1 ===")
    ...
    with psycopg2.connect(os.environ["DATABASE_URL"]) as conn:
        with conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor) as cur:
            ...
            for row in rows:
                total += 1
                buy += 1 if row["side"] == "BUY" else 0
                sell += 1 if row["side"] == "SELL" else 0
    ...
    print(f"LKOH_SIGNAL_SUMMARY signals_found={total} inserted={inserted} buy={buy} sell={sell}")
    print()
    print("runtime_allow=0")
    print("execution_enabled=0")
    print("VERDICT=LKOH_SHADOW_SIGNALS_RECORDED")
    print("LKOH_SHADOW_SIGNAL_RESEARCH_V1_OK")
    return 0
