...
def main() -> int:
    ...
    objects = ModelDiscovery(".").discover(context)

    print("=== MODEL_DISCOVERY_PLUGIN_V1 ===")
    ...
    print("discovery_source=ModelDiscovery")
    ...
    print("VERDICT=MODEL_DISCOVERY_PLUGIN_V1_READY")
    return 0
