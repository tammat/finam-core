...
def main() -> int:
    print("=== MARKET_STATE_CONTEXT_SCORECARD_V1 ===")
        ...
        with conn.cursor() as cur:
            cur.execute("""
                ...
                SELECT
                    ...
                    COALESCE(ctx.fx_signature, 'NO_FX_CONTEXT') AS fx_signature,
                    COALESCE(ctx.energy_signature, 'NO_ENERGY_CONTEXT') AS energy_signature,
                    COUNT(*) AS trades,
                ...
                GROUP BY
                    tss.entry_compact_signature,
                    COALESCE(ctx.fx_signature, 'NO_FX_CONTEXT'),
                    COALESCE(ctx.energy_signature, 'NO_ENERGY_CONTEXT')
            ...
            """)
            context_links = cur.fetchone()[0]

    print("")
    print("CONTEXT_SCORECARD_ROWS")
    ...
    print("")
    print(f"context_links={context_links}")
    ...
    print("")
    print("VERDICT=MARKET_STATE_CONTEXT_SCORECARD_READY")
    return 0
