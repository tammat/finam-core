...
from marketcore.catalog.discovery.plugins.model_discovery import ModelDiscovery
...
def main() -> int:
    context = DiscoveryContext(
        profile="MODEL_DISCOVERY_PROFILE_V1",
        domain="MODELS",
        schema_filter=(),
        name_patterns=("MODELS",),
    )

    objects = DiscoveryExecutor([ModelDiscovery(".")]).run(context)
    ...
    print("VERDICT=MODEL_DISCOVERY_PROFILE_V1_READY")
    return 0
