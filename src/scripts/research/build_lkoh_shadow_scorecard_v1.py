...
DDL = """
CREATE TABLE IF NOT EXISTS lkoh_shadow_scorecard (
...
CREATE INDEX IF NOT EXISTS idx_lkoh_shadow_scorecard_symbol_created
ON lkoh_shadow_scorecard(symbol, created_at DESC);
"""
...
INSERT = """
INSERT INTO lkoh_shadow_scorecard (
    symbol,
    strategy,
    exit_bars,
    signals,
...
def main() -> int:
    print("=== LKOH SHADOW SCORECARD V1 ===")
    ...
    with psycopg2.connect(os.environ["DATABASE_URL"]) as conn:
        with conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor) as cur:
            ...
            if closed_trades >= 100 and expectancy is not None and expectancy > 0 and (profit_factor or 0) >= 1.2:
                verdict = "LKOH_SHADOW_SCORECARD_PASS"
            elif closed_trades < 100:
                verdict = "LKOH_SHADOW_SCORECARD_INSUFFICIENT_DATA"
            else:
                verdict = "LKOH_SHADOW_SCORECARD_REJECT"
    ...
    print("LKOH_SHADOW_SCORECARD_V1_OK")
    return 0
