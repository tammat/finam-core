...
def main() -> int:
    print("=== USDRUB SHADOW FAILURE ANALYSIS V1 ===")
    ...
    if avg_win is not None and largest_loss is not None and abs(largest_loss) > avg_win * 20:
    ...
    print("VERDICT=USDRUB_FAILURE_ANALYSIS_READY")
    print("USDRUB_SHADOW_FAILURE_ANALYSIS_V1_OK")
    return 0
