...
def main():
                    ...
                    for selection in selections:
                        for filter_name in r["filters"]:
                            for horizon_min, ret in r["future"].items():
                                if ret is not None:
                                    fixed_ret = -ret if selection.startswith("BOTTOM") else ret
                                    buckets[(selection, filter_name, horizon_min)].append(fixed_ret)
    ...
    print("=== FUTURES_RS_BOTTOM_REVERSAL_FILTERS_FIX_V1_1 ===")
    ...
    print("VERDICT=FUTURES_RS_BOTTOM_REVERSAL_FILTERS_FIX_V1_1_READY")
    print("TEST_FUTURES_RS_BOTTOM_REVERSAL_FILTERS_FIX_V1_1_OK")
    return 0
