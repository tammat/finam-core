...
def main():
    ...
    print("=== FUTURES_RS_BOTTOM_REVERSAL_FILTERS_FIX_V1 ===")
    ...
    print("VERDICT=FUTURES_RS_BOTTOM_REVERSAL_FILTERS_FIX_READY")
    print("TEST_FUTURES_RS_BOTTOM_REVERSAL_FILTERS_FIX_V1_OK")
    return 0
