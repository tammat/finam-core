...
def run_symbol(symbol: str, trade_source: str, limit: int, *, run_log: ResearchPipelineRunLog | None = None, run_id: int | None = None) -> int:
    ...
    steps = [
        ...
        [
            py, "src/scripts/features/enrich_trade_context_from_feature_snapshots.py",
            "--symbol", symbol,
            "--limit", str(limit),
        ],
        [
        ...
        [
            py, "src/scripts/research/build_strategy_performance.py",
            "--symbol", symbol,
            "--trade-source", trade_source,
            "--save",
        ],
        ...
        [
            py, "src/scripts/research/build_strategy_research_verdict.py",
            "--symbol", symbol,
            "--trade-source", trade_source,
            "--save",
        ],
