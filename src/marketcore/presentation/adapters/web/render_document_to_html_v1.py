...
class RenderDocumentToHtmlV1:
    ...
    _DOMAIN_TAG_BY_NODE_TYPE = {
        ...
        RenderNodeType.TABLE.value: "table",
        RenderNodeType.TABLE_HEAD.value: "thead",
        RenderNodeType.TABLE_BODY.value: "tbody",
        RenderNodeType.TABLE_ROW.value: "tr",
        RenderNodeType.TABLE_HEADER_CELL.value: "th",
        RenderNodeType.TABLE_CELL.value: "td",
