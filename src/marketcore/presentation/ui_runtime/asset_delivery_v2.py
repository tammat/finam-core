...
UI_RUNTIME_ASSETS_V2: tuple[UiRuntimeAssetDefinitionV2, ...] = (
    ...
    UiRuntimeAssetDefinitionV2("marketcore_logo", "/assets/marketcore/ui-runtime/v2/marketcore-logo-v2.png", "marketcore-logo-v2.png", "image/png"),
    ...
    UiRuntimeAssetDefinitionV2("workspace_shell_bootstrap", "/assets/marketcore/ui-runtime/v2/workspace-shell-bootstrap.js", "workspace_shell_bootstrap_v2.js"),
)
