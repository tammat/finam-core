...
def _scout_table(items):
    ...
    for index,item in enumerate(items,start=1):
        ...
        rows.append(RenderNodeV2(RenderNodeTypeV2.TABLE_ROW,f"research.scout.{index}",state=RenderNodeStateV2(status_code=status),children=(
