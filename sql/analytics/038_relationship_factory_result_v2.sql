CREATE TABLE IF NOT EXISTS analytics.relationship_factory_result_v2 (
    ...
    source_symbols JSONB NOT NULL,
    source_construction TEXT NOT NULL,
    ...
    UNIQUE(discovery_run_id,relationship_code,impulse_bars,lag_bars,regime_group,session_code)
);

CREATE INDEX IF NOT EXISTS relationship_factory_result_v2_rank_idx ON analytics.relationship_factory_result_v2
    (discovery_run_id,priority,verdict_code,adjusted_p_value,oos_profit_factor DESC);
